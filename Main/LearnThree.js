...
const LearnThree = ({ navigation }) => {
  const playSound = () => {
    try {

      SoundPlayer.playSoundFile('lion', 'mp3')
    } catch (e) {
  ...
  return (
    <View style={styles.wrapper}>
      ...
      <View style={styles.QuestionBox}>
        <Text style={styles.QuestionTxt}>أين الأسد ؟</Text>
        <TouchableHighlight
      ...
      <View style={styles.OptionsBox}>
        <View style={styles.row}>
          <TouchableHighlight
            ...
            underlayColor='grey'
            style={styles.option}>
            <Image source={require('../assets/cow.png')} style={styles.image} />
          </TouchableHighlight>
          <TouchableHighlight
            onPress={() => SelectOption('02')}
            underlayColor='grey'
            style={styles.option}>
            <Image source={require('../assets/lion.png')} style={styles.image} />
          </TouchableHighlight>
        </View>
        <View style={styles.row}>
          <TouchableHighlight
      ...
      <View style={answer ? styles.resulte : styles.hidden}>
        <Text style={styles.ResTxt}> عمل جيد لقد أتممت المرحلة</Text>
        <TouchableHighlight
