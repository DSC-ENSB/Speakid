...
const LearnTwo = ({ navigation }) => {
  const playSound = () => {
    try {
      ...
      SoundPlayer.playSoundFile('rabbit', 'mp3')
    } catch (e) {
  ...
  return (
    <View style={styles.wrapper}>
      ...
      <View style={styles.QuestionBox}>
        <Text style={styles.QuestionTxt}>أين الأرنب  ؟</Text>
        <TouchableHighlight
      ...
      <View style={styles.OptionsBox}>
        <View style={styles.row}>
          <TouchableHighlight
            ...
            underlayColor='grey'
            style={styles.option}>
            <Image source={require('../assets/eagle.png')} style={styles.image} />
          </TouchableHighlight>
          <TouchableHighlight
        ...
        <View style={styles.row}>
          <TouchableHighlight
            ...
            underlayColor='grey'
            style={styles.option}>
            <Image source={require('../assets/rabbit.png')} style={styles.image} />
          </TouchableHighlight>
          <TouchableHighlight
            onPress={() => SelectOption('04')}
            underlayColor='grey'
            style={styles.option} >
            <Image source={require('../assets/duck.png')} style={styles.image} />
          </TouchableHighlight>
        </View>
      </View>
      <View style={answer ? styles.resulte : styles.hidden}>
        ...
        <TouchableHighlight
          onPress={() => navigation.navigate('learnThree')}
          style={styles.next}>
          <Text>تم</Text>
        </TouchableHighlight>
      </View>
